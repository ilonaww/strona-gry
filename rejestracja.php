<?php
	...
	if (isset($_POST['nick']))
	{
		...
		//sprawdzenie czy użytkownik to robot
		$sekret = "6LeRUCkbAAAAAAlpVmSJTUXQSRuVUwl7LUGb9AnH";
...
<body>
	<div id="container">
		<form method="post" class="form">
			...
			<div class="g-recaptcha" data-sitekey="6LeRUCkbAAAAAK4pyJt9lvJ2CVlda1qwGdyRMUTq"></div>
